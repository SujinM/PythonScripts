...
setup.py
--------
cx_Freeze build script for TONHE Module HMI ADS.

Produces:
    build/exe.win-amd64-<py_ver>/   – standalone Windows executable tree
    dist/ToneHMI_ADS-<version>.msi  – Windows MSI installer (run bdist_msi)
...
APP_VERSION     = "2.0.0"
APP_DESCRIPTION = "TONHE Charging Module HMI – ADS Notifications (PyQt6 GUI)"
APP_AUTHOR      = "TwinCAT Tools"
APP_UPGRADE_CODE = "{C4E3B682-2A5D-5F3C-9B4E-8A0D1E974523}"   # stable GUID for MSI upgrades
MAIN_SCRIPT     = "app.py"

# ---------------------------------------------------------------------------
# Paths
# ---------------------------------------------------------------------------
HERE            = Path(__file__).resolve().parent           # tonhe_module_hmi_ads/
...
PACKAGES: list[str] = [
    ...
    "tone_hmi_ads.models",
    "tone_hmi_ads.views",
    "tone_hmi_ads.controllers",
    "tone_hmi_ads.workers",
    "tone_hmi_ads.utils",
