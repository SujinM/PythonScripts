      ...
      <div class="card p-5 space-y-4">
        ...
        <div>
          ...
          <div class="flex gap-3">
            <label v-for="t in ['call', 'put']" :key="t"
              :class="['flex-1 text-center py-2 rounded-lg border text-sm font-medium cursor-pointer transition-all',
                ivF.type === t ? 'bg-brand-500/15 border-brand-500/50 text-brand-400' : 'border-[var(--surface-border)] text-[var(--text-secondary)] hover:bg-white/5']">
      ...
      <div class="card p-5 space-y-4">
        ...
        <div>
          ...
          <div class="flex gap-3">
            <label v-for="t in ['call', 'put']" :key="t"
              :class="['flex-1 text-center py-2 rounded-lg border text-sm font-medium cursor-pointer transition-all',
                bsF.type === t ? 'bg-brand-500/15 border-brand-500/50 text-brand-400' : 'border-[var(--surface-border)] text-[var(--text-secondary)] hover:bg-white/5']">
